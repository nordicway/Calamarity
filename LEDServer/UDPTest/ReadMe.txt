========================================================================
    KONSOLENANWENDUNG: UDPTest-Projektübersicht
========================================================================

Diese UDPTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre UDPTest-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "UDPTest.pch und eine 
